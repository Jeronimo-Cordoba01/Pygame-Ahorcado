...
def main():
    ...
    while jugando:
        ...
        if tiempo_restante <= 0:
            ...
            mostrar_mensaje_final(screen, pizarra, "¡Se acabo el tiempo!", estado_juego["palabra"], ANCHO, ALTO )
                ...
                if letra.isalpha() and letra not in estado_juego["letras_ingresadas"]:
                    ...
                    if letra in estado_juego["palabra"]:
                        ...
                        if estado_juego["intentos_restantes"] == 0:
                            ...
                            mostrar_mensaje_final(screen, pizarra, "No te quedan más intentos, perdiste!", estado_juego["palabra"], ANCHO, ALTO)
                            reproducir_musica(musica_fondo, musica_perdedor)
                            sys.exit()
        ...
        if set(estado_juego["palabra"]) <= set(estado_juego["letras_adivinadas"]):
            ...
            mostrar_mensaje_final(screen, pizarra, "¡Adivinaste la palabra!", estado_juego["palabra"], ANCHO, ALTO)
